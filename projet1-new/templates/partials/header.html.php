...
// Inclure le fichier contenant la fonction activerPromotion
...
<body>
    ...
    <header class="header">
        ...
        <div class="flex-right">
            ...
            <div class="profil">
                <img src="assets/images/images.png" class="image" alt="">
                <div class="info">
                    <p style="font-size: 14px;"><?= $_SESSION['user']['nom'] ?></p>
                    <small style="font-size: 14px;"><?= $_SESSION['user']['statut'] ?> <i class="fa fa-angle-down" aria-hidden="true"></i></small>
                </div>
            </div>
            <div class="hoverable">
           <!-- <a href="profile.html" class="btn">Voir profile</a>-->
            <div class="flex-btn">
                <a href="/" class="option-btn">Se déconnecter</a>
            </div>
        </div> 
        </div>
    </header>
    <div class="side-bar">
        ...
        <nav class="navbar">
            <?php if ($_SESSION['user']['statut'] == 'etudiant') { ?>
                <a href="#" disabled><i class="fa-solid fa-bars-staggered fa-flip-horizontal"></i><span>Dashboard</span></a>
                <a href="#" disabled><i class="fa fa-graduation-cap" aria-hidden="true"></i><span>Apprenants</span></a>
                <a href="#" disabled><i class="fa-solid fa-clipboard-list" aria-hidden="true"></i> <span>Promos</span></a>
                <a href="#" disabled><i class="fas fa-calendar-alt" aria-hidden="true"></i><span>Référentiels</span></a>
                <a href="#" disabled><i class="fa fa-user-circle-o" aria-hidden="true"></i><span>Utilisateurs</span></a>
                <a href="#" disabled><i class="fa fa-user-circle-o" aria-hidden="true"></i><span>Visiteurs</span></a>
            <?php } else { ?>
            ...
            <?php if ($_SESSION['user']['statut'] == 'etudiant') { ?>
                ...
                <a href="/evenement"><i class="fas fa-calendar-alt" aria-hidden="true"></i><span>Événements</span></a>
            <?php } elseif ($_SESSION['user']['statut'] == 'admin') { ?>
                <a href="/presence?idpromo=<?php echo $_SESSION['idPromoActive']; ?>"><i class="fa fa-user-circle-o" aria-hidden="true"></i><span>Presence</span></a>
                <a href="/evenement"><i class="fas fa-calendar-alt" aria-hidden="true"></i><span>Événements</span></a>
            <?php } ?>
        </nav>
